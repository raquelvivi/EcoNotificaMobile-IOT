...
('São Paulo', 'SP', 'Brasil', '01001-000'),     -- id 1
('Rio de Janeiro', 'RJ', 'Brasil', '20040-002'),-- id 2
('Belo Horizonte', 'MG', 'Brasil', '30130-010'),-- id 3
('Salvador', 'BA', 'Brasil', '40010-000'),      -- id 4
('Porto Alegre', 'RS', 'Brasil', '90010-320'),  -- id 5
('Recife', 'PE', 'Brasil', '50030-230'),        -- id 6
('Fortaleza', 'CE', 'Brasil', '60010-000'),     -- id 7
('Brasília', 'DF', 'Brasil', '70040-010'),      -- id 8
('Curitiba', 'PR', 'Brasil', '80010-000'),      -- id 9
('Florianópolis', 'SC', 'Brasil', '88015-120'), -- id 10
('Currais Novos', 'RN', 'Brasil', '59380-000'); -- id 11
